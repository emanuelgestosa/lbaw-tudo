...
window.SERVER = "http://lbaw2215.lbaw.fe.up.pt";
...
if (acceptButtons) {
  var _iterator = _createForOfIteratorHelper(acceptButtons),
    _step;
  try {
    var _loop = function _loop() {
      var acceptButton = _step.value;
      acceptButton.addEventListener('click', function () {
        var inviteId = acceptButton.parentElement.querySelector('input[name=inviteId]').value;
        var userId = acceptButton.parentElement.querySelector('input[name=userId]').value;
        var options = {
          method: 'POST',
          headers: {
        ...
        (0,_app_js__WEBPACK_IMPORTED_MODULE_0__.sendRequest)("/api/user/".concat(userId, "/invites/").concat(inviteId), options);
  ...
  var _iterator2 = _createForOfIteratorHelper(declineButtons),
    _step2;
  try {
    var _loop2 = function _loop2() {
      var declineButton = _step2.value;
      declineButton.addEventListener('click', function () {
        var inviteId = declineButton.parentElement.querySelector('input[name=inviteId]').value;
        var userId = declineButton.parentElement.querySelector('input[name=userId]').value;
        // TODO : Precisamos de verificar a resposta
        var options = {
          method: 'DELETE',
          headers: {
