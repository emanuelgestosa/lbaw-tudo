...
(() => {
/*!************************************!*\
  !*** ./resources/js/popup-test.js ***!
  \************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _app_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./app.js */ "./resources/js/app.js");

var generatePopupButton = document.querySelector('button#spawn-popup');
generatePopupButton.addEventListener('click', function () {
  var popUp = document.querySelector('article.tu-do-popup');
  if (popUp) {
    popUp.remove();
  }
  var inputTitle = document.querySelector("input[name='popup-title']");
  var title = inputTitle.value;
  var inputText = document.querySelector("input[name='popup-text']");
