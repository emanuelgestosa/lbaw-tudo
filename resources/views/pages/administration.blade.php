...
@section('content')
  ...
  <div id="panel">
    ...
    <nav id="sub-tabs">
      <button class="sub-tab selected"><i class="fa-solid fa-ban"></i> Banned Users</button>
      <button class="sub-tab"><i class="fa-solid fa-plus"></i> Create User</button>
      <button class="sub-tab"><i class="fa-solid fa-search"></i> Search User</button>
    </nav>
    <div id="tab-content">
